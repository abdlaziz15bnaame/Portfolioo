        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-[2rem] items-center w-[80%] mx-auto '>
            <div>
                ...
                <p className='text-[15px] text-white mt-[1rem] opacity-75'>
                    ...
                    Illo dolorem deleniti magnam aspernatur tempora nam officiis natus ipsam fugit facilis. 
                    Perferendis quae obcaecati soluta sunt.
                </p>
            ...
            <div>
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-[1rem] items-center'>
                    ...
                    type="text"
                    placeholder='Name' 
                    className='py-[0.7rem] outline-name text-white bg-gray-800  rounded-md px-4'
                    />
                    <input
                    type="email"
                    placeholder='email' 
            ...
            />
            <textarea placeholder='Message' className='py-[0.7rem] mb-[1.5rem] w-full outline-none text-white bg-gray-800 rounded-md px-4' 
            rows={4}>
            </textarea>
